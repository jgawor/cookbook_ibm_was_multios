...
# <> Installation Manager Install Dir
# <md> attribute 'was/im_install_dir',
# <md>          :displayname => 'Installation Manager installation directory',
# <md>          :description => 'The installation root directory for the Installation Manager',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '/home/wasadmin/InstallationManager',
# <md>          :selectable => 'true',
# <md>          :immutable_after_create => 'true',
# <md>          :precedence_level => 'node',
# <md>          :parm_type => 'node',
...
default['was']['im_install_dir'] = '/home/wasadmin/InstallationManager'
...
when /^8.5.5/ # ~ip_checker
  #<> IBM Java 7 Version valid_options 7.0.9.30, 7.1.4.15
  default['was']['java_version'] = "7.1.4.15" # ~ip_checker
...
#<> WebSphere Operating System Users To Create
# <md>attribute 'was/os_users/wasrun/name',
# <md>          :displayname =>  'WebSphere runas userid',
# <md>          :description => 'Operating system userid that will be used to run the product. Userid will be created if it does not exist',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => 'wasadmin',
# <md>          :selectable => 'true',
...
# <md>attribute 'was/os_users/wasrun/gid',
# <md>          :displayname =>  'WebSphere runas user group name',
# <md>          :description => 'Operating system group name that will be assigned to the runas user, reccomended setting same value as install user',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => 'wasgrp',
# <md>          :selectable => 'true',
...
# <md>attribute 'was/os_users/wasrun/comment',
# <md>          :displayname =>  'WebSphere user comment for user',
# <md>          :description => 'Comment that will be added when creating the userid',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
...
# <md>attribute 'was/os_users/wasrun/home',
# <md>          :displayname =>  'WebSphere runas userid home directory',
# <md>          :description => 'Home directory location for operating system user that is used to run WebSphere',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '/home/wasrun',
# <md>          :selectable => 'true',
# <md>          :immutable_after_create => 'true',
# <md>          :precedence_level => 'node',
# <md>          :parm_type => 'node',
...
# <md>attribute 'was/os_users/wasrun/shell',
# <md>          :displayname =>  'WebSphere runas userid default shell',
# <md>          :description => 'Default shell for the operating system userid',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
# <md>          :default => '/bin/bash',
...
# <md>attribute 'was/os_users/wasrun/ldap_user',
# <md>          :displayname =>  'WebSphere to use LDAP for authentication',
# <md>          :description => 'A flag which indicates whether to create the WebSphere user locally, or utilize an LDAP based user',
# <md>          :type => 'string',
# <md>          :required => 'recommended',
