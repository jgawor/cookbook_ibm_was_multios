...
property_value_initial = node['was']['wsadmin']['standalone']['jvmproperty']['property_value_initial']
property_value_maximum = node['was']['wsadmin']['standalone']['jvmproperty']['property_value_maximum']
node_name = was_tags(node['was']['wsadmin']['standalone']['jvmproperty']['node_name'])
server_name = node['was']['wsadmin']['standalone']['jvmproperty']['server_name']

# Set the initial heap size
set_heap_size_standalone(profile_path, admin_user, admin_user_pwd, os_user, property_name_initial, property_value_initial, property_name_maximum, property_value_maximum, node_name, server_name)
