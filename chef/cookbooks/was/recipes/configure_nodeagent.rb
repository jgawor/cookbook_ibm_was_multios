...
propertyvalueinitial = node['was']['wsadmin']['nodeagent']['jvmproperty']['property_value_initial']
propertyvaluemaximum = node['was']['wsadmin']['nodeagent']['jvmproperty']['property_value_maximum']
nodename = was_tags(node['was']['wsadmin']['nodeagent']['jvmproperty']['node_name'])
servername = node['was']['wsadmin']['nodeagent']['jvmproperty']['server_name']
