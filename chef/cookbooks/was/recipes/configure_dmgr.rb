...
profile_path = node['was']['wsadmin']['dmgr']['jvmproperty']['profile_path']
property_value_initial = node['was']['wsadmin']['dmgr']['jvmproperty']['property_value_initial']
property_value_maximum = node['was']['wsadmin']['dmgr']['jvmproperty']['property_value_maximum']
node_name = was_tags(node['was']['wsadmin']['dmgr']['jvmproperty']['node_name'])
server_name = node['was']['wsadmin']['dmgr']['jvmproperty']['server_name']
