...
propertyvalueinitial = node['was']['wsadmin']['dmgr']['jvmproperty']['property_value_initial']
propertyvaluemaximum = node['was']['wsadmin']['dmgr']['jvmproperty']['property_value_maximum']
nodename = was_tags(node['was']['wsadmin']['dmgr']['jvmproperty']['node_name'])
servername = node['was']['wsadmin']['dmgr']['jvmproperty']['server_name']
